...
L1 = 0.235;                       %     [m] Total lenght of pendulum 1
L2 = 0.245;                       %     [m] Total lenght of pendulum 2
...
Ib = 1/12*m2*(0.01^2+L2^2);


% density of Aluminium
p1 = 2700; % kg/m^3
% Volume of Cylinder
volume_cyl = L1*0.015*0.015;
% mass of cylinder
m_cylinder = volume_cyl*p1;
% Moment of Inertia of cylinder
I_cyl = 1/12*m_cylinder*(0.015^2+L1^2);
...
Ia = motor_mass*L1^2+I_cyl;       % [kg mm^2] Inertia of Pendulum 1 from shoulder
Ib=Ia;

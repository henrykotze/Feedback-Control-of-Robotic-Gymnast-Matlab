...
duty_cycle = 20:1:43;
voltage = [42 58 69 88 110 120 140 154 180 203 222 240 265 304 320 355 370 400 422 470 490 533 547 578 ]./(150).*375;
...
legend({'Experimental Data','Linear Fit: $y = 59.2x -1168.8$'},'Interpreter','latex','FontSize',12)
grid on
xt = get(gca, 'XTick');
set(gca, 'FontSize', 12);
yt = get(gca, 'YTick');
